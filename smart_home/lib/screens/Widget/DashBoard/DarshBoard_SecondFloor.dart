...
class DarshBoardSecondFloor extends StatefulWidget {
  const DarshBoardSecondFloor({Key? key}) : super(key: key);

  @override
  State<DarshBoardSecondFloor> createState() => _DarshBoardSecondFloorState();
}

class _DarshBoardSecondFloorState extends State<DarshBoardSecondFloor> {
  bool status = false;
  late bool ledstatus;
  late int leddata = 0;
